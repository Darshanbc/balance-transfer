...
var getRegisteredUser = async function(username, userOrg,pwd,role, isJson) {
	try {
		...
		if (user && user.isEnrolled()) {
			...
			logger.debug(X509.parseCert(user._identity._certificate));// 
			//logger.debug("cert extensions[......] "+cert)
